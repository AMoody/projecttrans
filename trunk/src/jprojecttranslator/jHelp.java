...
public class jHelp extends javax.swing.JDialog {
    ...
    public jHelp(java.awt.Frame parent, boolean modal) {
        ...
        intWindowWidth = screenSize.width/2;
        intWindowHeight = 7 * screenSize.height/8;
        intWindowX = (screenSize.width-intWindowWidth)/2;
        intWindowY = (screenSize.height-intWindowHeight)/2;
        setSize(new java.awt.Dimension(intWindowWidth, intWindowHeight));
        setLocation(intWindowX,intWindowY);
